...
public class MD5 {
	...
	public String toMD5Str(byte[] inbuf) {
		keyBeanInit();
	...
	private void keyBeanTransform(byte block[]) {
		...
		Decode(x, block, 64);
		/* Round 1 */
		a = FF(a, b, c, d, x[0], S11, 0xd76aa478L);  /* 01 */
		d = FF(d, a, b, c, x[1], S12, 0xe8c7b756L);  /* 02 */
		c = FF(c, d, a, b, x[2], S13, 0x242070dbL);  /* 03 */
		b = FF(b, c, d, a, x[3], S14, 0xc1bdceeeL);  /* 04 */
		a = FF(a, b, c, d, x[4], S11, 0xf57c0fafL);  /* 05 */
		d = FF(d, a, b, c, x[5], S12, 0x4787c62aL);  /* 06 */
		c = FF(c, d, a, b, x[6], S13, 0xa8304613L);  /* 07 */
		b = FF(b, c, d, a, x[7], S14, 0xfd469501L);  /* 08 */
		a = FF(a, b, c, d, x[8], S11, 0x698098d8L);  /* 09 */
